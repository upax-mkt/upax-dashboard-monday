...
// Solo App() con state y routing. Toda la lógica en lib/ y components/
// v8.0 · P4.3

import React, { useState, useEffect, useRef, useMemo, useCallback } from 'react'

import { BOARD_ID, SQUADS, PERSONAS, AGENDA, PHASES, MONDAY_USERS, TODAY_STR, TODAY, WEEK, PREV_WEEK, STORE_KEY, CACHE_KEY, WEEKLY_MAR23, emptyWeekly, normalizeSquad } from './lib/constants'
import { normalizePersonName, isTeamMember, parseTL, addDays, getMondayStr, daysDiff, isOverdue, isActive, overlapsThisWeek, pctColor, shortName, getPersonDetail, downloadTextFile, copyToClipboard, PHASE_SHORT, WEEK as WEEK_UTIL } from './lib/utils'
...
import { Bar, Card, Chip, Alerta, PersonSelect, CopyModal, PersonDetailView, NumInput, SquadInputSection } from './components/ui'
